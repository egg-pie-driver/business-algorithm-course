...
<audio src='./02｜双向链表：list如何实现高效地插入与删除？.mp3' controls></audio>
你好，我是微扰君。
...
![图片](images/467464/57a4afd78ed47c5f4dedd450c87b8c5f.jpg)
...
![图片](images/467464/fb50a216ba0f4d38461427d13cd0d9a5.jpg)

其中，单链表和双链表最大的区别就在于，单链表的引用域，只存了一个后继指针。

![图片](images/467464/a42ab74b0ceaf7675eb07b830e986c02.jpg)

而双链表有两个引用域，不只存有后继节点的地址，也存储了前驱节点的信息，这使得我们 **可以双向遍历链表，拥有了在遍历中回退的能力**。在链表首尾的前驱和后继指针，可以设为NULL或者指向一个特殊的虚拟节点，来标记链表的终结。

![图片](images/467464/b02c37b3d8ba0a9a213e3ff1d1461ee6.jpg)
...
![图片](images/467464/d090e6a6c8ff2e4f6da3b6d5a2c48b62.jpg)
