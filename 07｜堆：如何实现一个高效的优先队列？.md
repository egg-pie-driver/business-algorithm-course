# 07｜堆：如何实现一个高效的优先队列？
<audio src='./07｜堆：如何实现一个高效的优先队列？.mp3' controls></audio>
你好，我是微扰君。
...
![图片](images/472166/031f3908df1315910fab5543a50e9575.jpg)
...
![图片](images/472166/804e072a611c89dc87f762f1119c08c9.jpg)
...
![图片](images/472166/9e58f9e5d39a0ef5748ea511ae481e82.jpg)
...
![](images/472166/9f8fc9d9e5ca9d60da352219c4c62209.jpg)

相信你也发现了，图中的数组就是 **按照对树做层序遍历的方式依次排列的**，所以数组中下标为0的元素就是堆顶的元素，我们也用箭头将数组元素中的父子关系都标记出来了。由于二叉树每一层元素个数都是上一层两倍的特性，你会发现，queue\[k\]节点，它的左子节点为queue\[2 _k+1\]，右子节点为queue\[2_ k+2\]。
...
![图片](images/472166/fyy22c38b93f0fda3a33682eea0db823.jpg)
...
![图片](images/472166/ac8d9a6bc4fa5cdac42a286ccf250042.jpg)
...
![图片](images/472166/a8ea7c6bd1d46c96aaca2c4c0da1ca21.jpg)
...
![图片](images/472166/abfff0c466175ab7427127784a14b5db.jpg)
...
核心就是数组中父子节点的下标关系。下标为k的节点queue\[k\]，它的左子节点为queue\[2 _k+1\]，右子节点为queue\[2_ k+2\]。理解了这一点，去实现siftDown和siftUp操作，相信对你来说不在话下。
